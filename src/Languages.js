export const languages = {
  ...
  ar: {
    ...
    emailDirtyNewPassword:
      "الرجاء إدخال عنوان بريد إلكتروني صالح لإعادة تعيين كلمة المرور",
    skip: "تخطي",
  ...
  de: {
    ...
    resetPasswordSent:
      "Eine E-Mail zum Zurücksetzen des Passworts wurde gesendet an",
    ...
    confirmationTextWillBeSent:
      "Ein Bestätigungstext wird an Ihre Telefonnummer gesendet, die endet auf",
  ...
  es: {
    ...
    resetPasswordSent:
      "Se ha enviado un correo electrónico para restablecer la contraseña a",
    ...
    confirmationTextWillBeSent:
      "Se enviará un texto de confirmación a tu número de teléfono terminado en",
    ...
    emailDirtyNewPassword:
      "Por favor, ingresa una dirección de correo válida para restablecer tu contraseña",
    skip: "Omitir",
    errors: {
      "auth/invalid-login-credentials":
  ...
  en: {
    ...
    confirmationTextWillBeSent:
      "A confirmation text will be sent to your phone number ending in",
  ...
  fr: {
    ...
    somethingWentWrong:
      "Un problème est survenu. Essayez de nouveau plus tard.",
    ...
    confirmationTextWillBeSent:
      "Un texto de confirmation sera envoyé à votre numéro de téléphone se terminant par",
  ...
  hi: {
    ...
    countryCode: "देश कोड",
    confirmationTextWillBeSent:
      "आपके फोन नंबर पर एक पुष्टिकरण टेक्स्ट भेजा जाएगा जो समाप्त होता है",
    ...
    emailDirtyNewPassword:
      "कृपया अपना पासवर्ड रीसेट करने के लिए एक मान्य ईमेल पता दर्ज करें",
    skip: "छोड़ें",
    errors: {
  ...
  pt: {
    ...
    confirmationTextWillBeSent:
      "Um texto de confirmação será enviado para o seu número de telefone terminando em",
    ...
    emailDirtyNewPassword:
      "Por favor, insira um endereço de email válido para redefinir sua senha",
    skip: "Pular",
    errors: {
  ...
  ru: {
    ...
    confirmationTextWillBeSent:
      "Текст подтверждения будет отправлен на ваш номер телефона, оканчивающийся на",
    ...
    emailDirtyNewPassword:
      "Пожалуйста, введите действительный адрес электронной почты чтобы сбросить пароль",
    skip: "Пропустить",
