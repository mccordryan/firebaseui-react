...
export default function PhoneNumber({ setSendSMS, setAlert, setError, callbacks }) {
    ...
    return (
        <>
            ...
            <h1 className="font-semibold text-lg mb-2">{enterCode ? "Enter Code Below" : "Send a Sign-In Text"}</h1>

            {!enterCode &&
                <form className="flex gap-2">
                    <select className="py-1 px-2 border border-gray-300 rounded-md" value={countryCode} onChange={(e) => setCountryCode(e.target.value)}>
